...
admin_p = user_p + [
    ...
    BotCommand("kick_not_emby", "踢出群内无Emby账号的用户 [管理]"),
    BotCommand("renew", "调整到期时间 [管理]"),
    BotCommand("rmemby", "删除用户[包括非tg] [管理]"),
    BotCommand("prouser", "增加白名单 [管理]"),
    BotCommand("revuser", "减少白名单 [管理]"),
    BotCommand("rev_white_channel", "移除频道白名单 [管理]"),
    BotCommand("white_channel", "添加频道白名单 [管理]"),
    BotCommand("unban_channel", "解封频道 [管理]"),
    BotCommand("syncgroupm", "清理不在群内的用户 [管理]"),
    BotCommand("syncunbound", "清理未绑定bot的用户 [管理]"),
    BotCommand("scan_embyname", "扫描同名的用户记录 [管理]"),
    BotCommand("low_activity", "手动运行活跃检测 [管理]"),
    BotCommand("check_ex", "手动到期检测 [管理]"),
    BotCommand("uranks", "手动运行观影时长榜 [管理]"),
    BotCommand("days_ranks", "手动运行播放次数日榜 [管理]"),
    BotCommand("week_ranks", "手动运行播放次数周榜 [管理]"),
...
owner_p = admin_p + [
    ...
    BotCommand("paolu", "删除所有用户数据 [owner]"),
